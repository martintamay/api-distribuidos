...
public class PromotionsResource {
	...
	public PromotionsDTO getById(@PathParam("id") Integer promotionsId) {
	...
	@Produces({"application/xml", "application/json"})
	public PromotionsResult find(@PathParam("page") Integer page,@PathParam("size") Integer size,@PathParam("text") String text) {
		return promotionsService.find(text, page, size);
	}
	@GET
	@Path("/{page}/{size}")
	@Produces({"application/xml", "application/json"})
	public PromotionsResult getAll(@PathParam("page") Integer page, @PathParam("size") Integer size) {
	...
	@POST
	@Produces({"application/xml", "application/json"})
	public PromotionsDTO save(PromotionsDTO promotions) {
		return promotionsService.save(promotions);
	}
	@DELETE
	@Path("/{id}")
	public void delete(@PathParam("id") Integer promotionsId) {
		PromotionsDTO promotions = promotionsService.getById(promotionsId);
	...
	@Path("/{id}")
	@Produces({"application/xml", "application/json"})
	public PromotionsDTO update(PromotionsDTO promotions, @PathParam("id") Integer promotionsId) {
